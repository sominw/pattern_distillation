...
python3 generate_train.py --dataset alpaca --model_id meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo --together_api true
python3 generate_train.py --dataset alpaca --model_id mistralai/Mixtral-8x7B-Instruct-v0.1 --together_api true
python3 generate_train.py --dataset alpaca --model_id allenai/OLMo-7B-Instruct --together_api true
